...
In this example, we use the zero--one loss, under which the optimal strategy predicts the class label with the highest
...
assigned class.
For instance, when the first input bit of $f_2$ is 1, the class is often D, creating a misleading
