...
for some \inSet{Q}, so that all logarithms are well-defined.
...
As discussed later, in the case of sequences of random variables, central distributions are defined on the
