...
A natural choice for this purpose is the central divergence introduced in Definition~\ref{def:central-divergence}.
...
\begin{proof}
    ...
    Then for any probability distribution~$Q$,
    \[
        \kl = \ln Z - \engFunc.
    \]
...
measure $\tilde P$ for which $\engFunc$ is approximately constant with respect to $Q$.
