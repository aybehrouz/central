...
\begin{lemma}
    Let $X$ be a random variable and $P$, $Q$, and $R$ be probability distributions.
    For the Kullback-Leibler divergence the following inequality holds:
    \begin{equation*}
        \kl \geq \klRatio
    \end{equation*}
\end{lemma}
...
\begin{theorem}
    Assume for probability distributions $P$, $Q_1$ and $Q_2$ we have:
    \begin{equation*}
        \kl[Q_1] \leq \kl[Q_2]
    \end{equation*}
    If $Q = \alpha Q_1 + (1 - \alpha) Q_2$, for some $0 \leq \alpha \leq 1$.
    Then,
    \begin{equation*}
        \kl \leq \kl[Q_2] \cdot
    \end{equation*}
