...
General existence and uniqueness results for infinite sequences remain open.
...
\begin{conjecture}
    ...
    \end{equation}
    where \infSeq{\mu} is a sequence of positive constants and $P(\paramVal \mid\est_n)$ denote the posterior
...
\end{equation*}
With appropriate additional assumptions, the conditions of Theorem~\ref{th:limiting-centrality} can be satisfied.
Thus, $\cPrior(\paramVal)$ is expected to be a central prior for the estimator sequence~\infSeq{\est}.
