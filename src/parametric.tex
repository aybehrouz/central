...
\begin{proof}
    ...
    \[
        \sFunc[P][\setQ] = \sFunc[P][\setQ \cup \{R\}]. \qedhere
    \]
\end{proof}
...
\begin{proof}
    ...
    \]
    This holds for all \paramVal, and \cPrior is a strictly positive distribution,
    by Theorem~\ref{th:centrality} it follows that \cDist is a central distribution of \setQ for $X$.
    Thus, by definition, \cPrior is a central prior of \setQ for $X$.
\end{proof}
