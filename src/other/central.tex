...
By convergent distribution, we mean a distribution with sufficiently low divergence from any other distribution in the
set.
...
When dealing with multi-level ignorance and attempting to determine the central distribution of a set of sets of
