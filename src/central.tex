...
\begin{definition}\label{def:center-of-set}
    ...
    We say that a distribution $C$ is a \emph{\cd}\ if for any probability
...
By convention, every probability distribution is regarded as its own central distribution.
...
\begin{definition}[Central Divergence]
    ...
    \end{equation*}
    where the infimum is taken over all central distributions $\cDist$ of \set{H} for $X$.
\end{definition}
