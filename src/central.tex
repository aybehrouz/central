...
We call this modeling assumption the \emph{principle of objectivity}.
...
\end{notation}
This notation will be used throughout the sequel and allows Definition~\ref{def:center-of-set} to be written
compactly as
\[
