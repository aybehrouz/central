...
Because $\est_n$ is a consistent estimator for every \paramVal, the sampling distribution $\estLike$ becomes
...
Thus, $\cPrior(\paramVal)$ is expected to act as a central prior for the estimator sequence \infSeq{\est}.
