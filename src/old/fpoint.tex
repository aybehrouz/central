...
\begin{proof}
    ...
    To prove the `if' direction, we assume for every value of \paramValue,
    Equation~\ref{eq:pus_th_Dx_is_const} holds for
    a probability measure $\solDist$, induced by a strictly positive prior $\solPrior$.
