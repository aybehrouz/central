With the concept of hierarchical central distributions established, we now develop the theoretical machinery needed
...
\begin{proof}
    ...
    Since \cDist satisfies these conditions, Lemma~\ref{lm:saddle_conditions} and
