...
If we want our central distribution to exhibit good convergence properties for  $P(\X[i] \mid \seqRv[Y]{i-1})$,
we need to explicitly include these conditional pairs in our query set, in the same way we did for $\X[i]|\seqRv{i-1}$.

After adding these pairs, the central distribution for this new query set shows some interesting feature
...
It can be said that this central distribution identifies that $01$ and $11$ are both odd numbers.
