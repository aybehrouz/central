...
\subsection{Probability as a Linear Map}\label{subsec:probability-as-a-linear-map}
...
\begin{definition} [Sure Thing]
    The \emph{sure thing}, denoted by \sure[], is a member of \A{s} such that for every \inS we have
    $\sure[](s) = 1$.
\end{definition}

\begin{definition}
    Let \inA{\act[]} and let \eventInS.
    The restriction of \act[] to \event, denoted by \act, is a member of \A{s} such that
    \[
        \act(s) =
        \begin{cases}
            \act[](s)       & s \in \event, \\
...
\begin{definition} [Expectation]
    ...
    \begin{itemize}
        ...
        \item For the restriction of the sure thing to \eventInS, we have $\Es[\sure] \geq 0$.
    \end{itemize}
\end{definition}
...
\begin{definition} [Conditional Expectation]
    ...
    \begin{itemize}
        ...
        \item For any \inA{\act[]}, and the restriction of \act[] to \eventInS,
...
\begin{definition} [Probability]
    Let $\event \subseteq \set{s}$, and \sure be the restricted sure thing on \event.
...
\begin{proof}
    ...
    Clearly, the restriction of $\act[]'$ to \event is the zero function, and therefore $\Es[\act'] = 0$.
    ...
    Consider \Ae is the set of all restricted actions to \event.
