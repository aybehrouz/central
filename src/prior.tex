...
This implies that we could have defined our query set as a single random variable \X, representing the vector of $n$
dice rolls: $\X = (\seqRv{n})$.
This is not surprising.
This vector corresponds to the entire sample set for $n$ dice rolls.
