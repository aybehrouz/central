...
Let us assume that a real number can be used to measure this loss, and denote it as $\klx[][][][ ]$.
...
\begin{theorem}
    ...
    Suppose $\klx[][][][ ]$ is some divergence measure that quantifies the divergence of $P(X)$ from $Q(X)$.
    ...
    \begin{description}
        ...
        \[
            \klx[Q][U][\varOmega][ ] = \entropy{U}{\varOmega} - \entropy{Q}{\varOmega},
        \]
        ...
        \[
            \klx[][][X, Y][ ] = \klx[][][][ ] + \sum_x \klx[][][Y|x][ ]Q(x)\cdot
        \]
    \end{description}
...
\begin{theorem}
    ...
    \begin{equation*}
        \klx \leq \convex{\klx[Q_1]}{\klx[Q_2]} \cdot
    \end{equation*}
