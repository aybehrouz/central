...
Each action associates an amount of loss with every \inS.
...
\begin{definition} [Expectation]
    An \emph{expectation} for \set{s} is a linear functional on \A{s}, denoted by $\Ex{\set{s}}{\cdot}$, with the
    following
    properties:
    \begin{itemize}
...
\begin{definition} [Probability]
    \renewcommand{\l}{\ell_{\event}}
    \newcommand{\event}{\set{e}}
    Let $\event \subseteq \set{s}$, and \inA{\l}, such that
    \[
        \l(s) =
        \begin{cases}
            1       & s \in \event, \\
