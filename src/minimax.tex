...
One insight provided by the next theorem is that it suggests inference and searching for a central
distribution can be combined and performed simultaneously.
...
\begin{proof}
    ...
    Suppose that for every \inSet{Q}, we have
    \[
        \kl > \lambda.
    \]
    This implies that
