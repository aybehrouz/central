...
\newcommand{\myDiv}[1][P(X)]{\measure{D}{\mathrm{CD}}{\setQ \,\middle\|\, #1}}
...
In this work, we adopt the perspective that a set of distributions provide a meaningful representation of the state of
partial knowledge, and that this representation can likewise be used for inference.

Importantly, the act of choosing this set reflects some degree of knowledge.
If even that knowledge is partial, we may similarly represent our uncertainty by a set of sets of
distributions---capturing deeper layers of ignorance.
...
\begin{proof}
    ...
    \]
    Therefore, combining this inequality with Inequality~\ref{eq:th5-proof}, we conclude that $R(\XIT)C(T)$ is a
