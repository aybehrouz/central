...
\begin{proof}
    For every $n \geq M$, by Theorem~\ref{th:centrality}, there exists a constant \(\mu_n\) such that for
    all \inSet{Q}
    \[
        \kl[][\cDist_n][S_n] = \mu_n .
    \]
    ...
    \begin{align*}
        ...
        &= 0 .
    \end{align*}
    Since $\cDist_n$ satisfies the conditions of Theorem~\ref{th:centrality}, it is a convex combination of
    elements of \setQ.
