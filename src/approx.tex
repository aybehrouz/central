...
\begin{proof}
    ...
    \[
        \myDiv[P][Q][] \leq \sFunc[][\setQ] - \sFunc[\cDist][\setQ].
    \]

    Since $P$ is a convex combination of elements of \set{R} with strictly positive weights,
    Corollary~\ref{cor:imperfection} implies that
    \[
        \sFunc[\cDist][\setQ] \geq \infR \kl.
    \]
