...
distribution $Q(\xIt)$.
Then, the weight function, $R(i)$, will essentially become a prior distribution over \paramVal.

The next theorem shows that there is a strong relationship between central distributions and
...
The above condition defines an implicit fixed-point equation for the central prior.
Existence and uniqueness are not addressed here and may depend on the structure of the model family.