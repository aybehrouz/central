...
\begin{definition}[Central Distribution]\label{def:central-dist}
...
It also provides a way to evaluate probability distributions relative to partial knowledge, motivating the
